                ...
                <ul className="space-y-2">
                   {navItems
                     ...
                     ?.submenuItems.map((subItem, index) => (
                      <li key={index}>
                        <Link 
                          to={activeDropdown === "About" ? `/about/${subItem.toLowerCase().replace(/\s+/g, '-')}` : `/`}
                ...
                {navItems
                  ...
                  ?.images.map((image, index) => {
                    ...
                    if (activeDropdown === "Shop") {
                      if (image.label === "Rings") linkTo = "/";
                      else if (image.label === "Earrings") linkTo = "/";
                  ...
                  >
                   ...
                   <div className="mt-3 pl-4 space-y-2">
                     {item.submenuItems.map((subItem, subIndex) => (
                       <Link
                         key={subIndex}
                         to={item.name === "About" ? `/about/${subItem.toLowerCase().replace(/\s+/g, '-')}` : `/`}
